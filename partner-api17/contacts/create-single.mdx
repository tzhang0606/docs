...
description: 'Create a new contact and add it to a group'
---
...
{
  "error": "organization_id, user_id, phone_number, and list_id are required. Create a group first using POST /v1/contacts/groups",
  "received": {
  ...
  "hint": "Contacts must belong to a group. Create a group first, then add contacts to it.",
  "powered_by": "Teli"
}
```
