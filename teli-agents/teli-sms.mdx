---
title: "Starting SMS Campaigns"
description: "Learn how to create and launch an SMS campaign with Teli AI."
icon: "comment"
---
...
<video controls className="w-full aspect-video" src="https://res.cloudinary.com/ayjgpoal/video/upload/campaign_creation_y3mbgj.mp4" />
...
Navigate to **SMS Campaigns** and create a new campaign. After naming your campaign, select the **SMS agent** that will run it and the **contact group** you would like to send texts to.
