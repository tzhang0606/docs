...
curl -X PATCH "https://api.teli.ai/v1/agents/1763763759612x739630924151608142" \
  ...
  -H "Content-Type: application/json" \
  -d '{
    "agent_name": "Mbuemo coffee",
    "starting_message": "Hi {{first_name}}, did you want to develop a software for your business?",
    "prompt": "You are Bryan Mbuemo working for Pranta Nir Software Solutions. You are supposed to ask users if they want any consulting or software development support..."
  }'
```
...
<Info>
  **For Voice Agents**: To update function calling, transfers, API integrations, and other tools, use the dedicated [Update Voice Agent Tools](/api-reference/agents/update-tools) endpoint.
