...
<ResponseField name="skipped_dnc" type="number">
  Number of contacts skipped because they are on the organization's Do-Not-Call (DNC) list
</ResponseField>
...
<ResponseField name="results" type="array">
  ...
  <Expandable title="result properties">
    ...
    <ResponseField name="status" type="string">
      `"sent"`, `"failed"`, or `"skipped_dnc"` (contact is on the DNC list)
    </ResponseField>
...
{
  "success": true,
  "message": "Bulk SMS complete: 2 sent, 1 failed, 0 skipped (DNC)",
  "total": 3,
  "sent": 2,
  "failed": 1,
  "skipped_dnc": 0,
...
- **DNC numbers are skipped automatically** — contacts on the organization's Do-Not-Call list are not messaged; they appear in `results` with `status: "skipped_dnc"` and are counted in the `skipped_dnc` total
