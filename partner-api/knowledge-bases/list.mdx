...
<ParamField query="user_id" type="string">
  User unique_id. Optional. When `is_admin=false` and a `user_id` is supplied, results are limited to that user's knowledge bases; if omitted, all of the organization's knowledge bases are returned.
</ParamField>
