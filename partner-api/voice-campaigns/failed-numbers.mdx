...
<ParamField query="format" type="string" default="detailed">
...
<ParamField query="include_no_answer" type="boolean" default="true">
  Include unanswered calls as failed
</ParamField>

<ParamField query="include_busy" type="boolean" default="true">
  Include busy calls as failed
</ParamField>
