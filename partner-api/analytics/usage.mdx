...
curl "https://api.teli.ai/v1/analytics/usage?organization_id=1767623610019x414651971228139500" \
  -H "X-API-Key: YOUR_API_KEY"
```

```bash cURL (User)
curl "https://api.teli.ai/v1/analytics/usage?user_id=1768236789852x707565875153419434" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript JavaScript
const response = await fetch(
  'https://api.teli.ai/v1/analytics/usage?organization_id=1767623610019x414651971228139500',
  {
    headers: {
...
response = requests.get(
    'https://api.teli.ai/v1/analytics/usage',
