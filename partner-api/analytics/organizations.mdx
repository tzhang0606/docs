...
<ResponseField name="period" type="object">
  ...
  <Expandable title="properties">
    <ResponseField name="start_date" type="string">Start date</ResponseField>
    <ResponseField name="end_date" type="string">End date</ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="organizations" type="array">
  ...
  <Expandable title="organization object">
    ...
    <ResponseField name="total_users" type="integer">Number of users in this organization</ResponseField>
    ...
    <ResponseField name="response_rate_percent" type="number">SMS response rate as a percentage</ResponseField>
    <ResponseField name="total_cost_cents" type="integer">Total cost in cents</ResponseField>
    <ResponseField name="total_cost_dollars" type="number">Total cost in USD</ResponseField>
    <ResponseField name="sms_active" type="boolean">Whether the organization can send SMS</ResponseField>
  ...
  "organizations": [
    {
      ...
      "response_rate_percent": 23.1,
      "total_cost_cents": 44567,
      "total_cost_dollars": 445.67,
      "sms_active": true,
    ...
    },
    {
      ...
      "response_rate_percent": 27.8,
      "total_cost_cents": 27890,
      "total_cost_dollars": 278.90,
      "sms_active": true,
...
| Users | `total_users` | Number of users |
...
| Response Rate | `response_rate_percent` | SMS response rate (%) |
...
| Cost | `total_cost_dollars` | Total cost (USD) |
