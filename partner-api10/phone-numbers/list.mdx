...
<ParamField query="phone_type" type="string">
  Filter by phone type: `voice` or `sms`. If omitted, returns all types.
</ParamField>
...
<ResponseField name="phone_numbers" type="array">
  ...
  <Expandable title="Phone Number Object">
    ...
    <ResponseField name="is_available" type="boolean">
      Whether the phone number is available for new campaigns (SMS only)
    </ResponseField>
    
    <ResponseField name="campaign_id" type="string">
      10DLC Campaign ID this number is assigned to (SMS only, null if not assigned)
    </ResponseField>
