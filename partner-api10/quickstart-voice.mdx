...
- Explore [voice agent tools](/api-reference/agents/update-tools) for advanced functionality
- Link [knowledge bases](/api-reference/knowledge-bases/create) for enhanced responses
- View [call history](/api-reference/call-history/list) for analytics and recordings
- Check [phone numbers](/api-reference/phone-numbers/list) for available numbers
