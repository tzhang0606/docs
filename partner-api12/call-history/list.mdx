...
<ParamField query="sentiment" type="string">
  Filter by user sentiment: `Positive`, `Negative`, `Neutral`, `Unknown`
</ParamField>

<ParamField query="call_successful" type="string">
  Filter by call success: `true` or `false`
</ParamField>

<ParamField query="start_date" type="string">
  Filter calls after this date (ISO 8601 format, e.g., `2025-01-01T00:00:00.000Z`)
</ParamField>

<ParamField query="end_date" type="string">
  Filter calls before this date (ISO 8601 format, e.g., `2025-12-31T23:59:59.999Z`)
</ParamField>
...
<ResponseField name="calls" type="array">
  ...
  <Expandable title="Call Object">
    ...
    <ResponseField name="agent_name" type="string">
      Name of the voice agent that handled the call
    </ResponseField>
